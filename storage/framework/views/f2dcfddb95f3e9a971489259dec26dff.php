            ...
            <div class="glass-card rounded-3xl p-8 flex flex-col justify-center backdrop-blur-md">
                <div class="text-center md:text-left">
                    ...
                    <div class="flex justify-center md:justify-start mb-6">
                        <img src="<?php echo e(asset('images/logo TernakPark Wonosalam.png')); ?>"
                             alt="TernakPark"
...
<?php /**PATH D:\Tugas Akhir\2. Eksperimen Utama Tahap Machine Learning Aplikasi Keseluruhan\Aplikasi_TernakParkWonosalam REST API\ternakpark-frontend\resources\views/auth/login.blade.php ENDPATH**/ ?>