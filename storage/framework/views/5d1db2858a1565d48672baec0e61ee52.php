...
<?php $__env->startSection('header-title', 'Detail Kandang'); ?>
...
<div class="space-y-6">
    <div class="glass-card p-6">
        ...
        <div class="mt-6 flex justify-end">
            <a href="<?php echo e(route('pens.index')); ?>" class="inline-flex items-center gap-2 px-5 py-2 bg-white/10 hover:bg-white/20 text-white rounded-xl transition border border-white/20">
...
document.addEventListener('DOMContentLoaded', async function() {
    const id = '<?php echo e($penId ?? $pen["id"] ?? 0); ?>';
    if (!id || id === '0') {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Tugas Akhir\2. Eksperimen Utama Tahap Machine Learning Aplikasi Keseluruhan\Aplikasi_TernakParkWonosalam REST API\ternakpark-frontend\resources\views/pens/show.blade.php ENDPATH**/ ?>