...
<head>
    ...
    <style>
        /* ========== GLOBAL STYLE PREMIUM HIJAU GELAP ========== */
        * {
            font-family: 'Inter', sans-serif;
        }

        /* Sembunyikan elemen dengan x-cloak sebelum Alpine.js siap */
        [x-cloak] {
        ...
        /* Sidebar premium dengan efek glassmorphism gelap */
        .sidebar-premium {
        ...
        /* Top bar (header) dengan blur dan latar transparan */
        .top-bar {
        ...
        /* Toast Notification - Gaya gelap premium */
        .toast {
            position: fixed;
            bottom: 24px;
            right: 24px;
...
<body class="antialiased">
    ...
    <div id="loading-overlay">
        <img src="<?php echo e(asset('images/logo TernakPark Wonosalam.png')); ?>" alt="TernakPark" class="loading-logo">
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-72 sidebar-premium text-white flex flex-col shadow-xl">
            <div class="p-6 border-b border-white/10">
                <div class="flex items-center space-x-3">
                    <img src="<?php echo e(asset('images/logo TernakPark Wonosalam.png')); ?>" alt="TernakPark" class="h-10 w-auto object-contain">
                    <div>
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                <a href="<?php echo e(route('program.fattening')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('program.fattening') ? 'sidebar-item-active' : ''); ?>">
                    <i class="fas fa-weight-hanging w-5 text-center text-emerald-300"></i>
                    <span class="text-sm font-medium">Fattening Domba</span>
                </a>
                <a href="<?php echo e(route('program.breeding')); ?>" class="sidebar-item flex items-center space-x-3 px-3 py-2.5 <?php echo e(request()->routeIs('program.breeding') ? 'sidebar-item-active' : ''); ?>">
            ...
            <div class="p-4 border-t border-white/10">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold truncate text-white"><?php echo e(session('user')['name'] ?? 'Pengguna'); ?></p>
                        <p class="text-xs text-emerald-200/80 capitalize"><?php echo e(session('role') ?? 'role'); ?></p>
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="top-bar sticky top-0 z-20 px-8 py-4 flex justify-between items-center">
                <h1 class="text-2xl font-semibold"><?php echo $__env->yieldContent('header-title', 'Dashboard'); ?></h1>
            ...
            <div class="px-8 pt-6">
                <?php if(session('success')): ?>
                    <div class="mb-4 p-4 bg-emerald-900/50 border-l-4 border-emerald-500 text-emerald-100 rounded-xl shadow-sm flex items-center backdrop-blur-sm">
                        <i class="fas fa-check-circle mr-3 text-emerald-400"></i> <?php echo e(session('success')); ?>
                ...
                <?php if(session('error')): ?>
                    <div class="mb-4 p-4 bg-red-900/50 border-l-4 border-red-500 text-red-100 rounded-xl shadow-sm flex items-center backdrop-blur-sm">
                        <i class="fas fa-exclamation-circle mr-3 text-red-400"></i> <?php echo e(session('error')); ?>
...
<?php /**PATH D:\Tugas Akhir\2. Eksperimen Utama Tahap Machine Learning Aplikasi Keseluruhan\Aplikasi_TernakParkWonosalam REST API\ternakpark-frontend\resources\views/layouts/app.blade.php ENDPATH**/ ?>